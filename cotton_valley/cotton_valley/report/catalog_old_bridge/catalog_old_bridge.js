...
frappe.query_reports["Catalog Old Bridge"] = {
	filters: [
		...
		{ fieldname: "item_group", label: __("Product Type"), fieldtype: "Link", options: "Item Group",
			get_query: function () {
				...
				return {
					query: "cotton_valley.cotton_valley.report.catalog_old_bridge.catalog_old_bridge.get_product_types",
		...
		{ fieldname: "subcategory", label: __("Sub-Category"), fieldtype: "Link", options: "Product Subcategory",
			get_query: function () {
				...
				return {
					query: "cotton_valley.cotton_valley.report.catalog_old_bridge.catalog_old_bridge.get_subcategories",
		...
		report.page.add_inner_button(__("Download PDF"), function () {
			...
			let d = new frappe.ui.Dialog({
				...
				fields: [
					...
					{ fieldname: "footer_note", fieldtype: "Data", label: __("Footer Custom Text"), default: (current.footer_note || "") },
				...
				primary_action: function (values) {
					...
					const url = `/api/method/cotton_valley.cotton_valley.report.catalog_old_bridge.catalog_old_bridge.download_catalog_old_bridge_pdf?filters=${args}`;
